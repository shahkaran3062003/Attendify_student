...
public class OtpEditText extends  AppCompatEditText{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLinesPaint.setColor(getResources().getColor(R.color.primary_bg_light,context.getTheme()));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        textPaint.setColor(MaterialColors.getColor(getContext(),R.attr.text_color,Color.YELLOW));
